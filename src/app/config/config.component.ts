...
export class ConfigComponent implements OnInit {
  ...
  constructor(
    ...
    this._subscription = this.configService.invalidURL.subscribe(value => {
        ...
        this.configService.validateURL(this.fhirURL).subscribe(res => {
          ...
          this.configService
            ...
            .subscribe((response: Response) => {
              ...
              this.secureServerSaved = false;
              this.serverDetailsSaved = true;
              this.responseBody1 = response.body;
              this.util.dsId = this.responseBody1.dsId;
              this.util.notify(
                'FHIR Server URL Saved Successfully.',
                'success',
                'Saved'
  ...
  /*getErrorMessage(){
    var openurl = 'https://fhirprod.sitenv.org/open-fhir/fhir';
     if(openurl === this.myForm.get('openurlFormControl').value){
      console.log('success');
    }
     else {
     var error = console.log('The Provided URL does not support Patient/$export','406');
     return error;
 }
  }*/
}
